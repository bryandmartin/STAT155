---
title: "STAT 155, Lecture Slides 1"
...
.middler[**Goal:** Create a functional R Markdown document utilizing basic R functionality (Homework 1)]
...
* an attempt at making statistics as fun for you as it is for me!
...
--
1. Somewhere on your computer, create the folder `STAT155`
2. Within that folder, create the subfolders `Homeworks` and `Projects`
3. Within your Homeworks folder, create a subfolder `homework1`
...
3. Save the file in your new folder, call it `homework1.Rmd`
  * *Hint:* Follow along, because this will become your Homework 1 submission!
...
Congrats! You have a functional .Rmd that will soon be your Homework 1 submissions!
